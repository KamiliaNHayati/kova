;; Kova Agent Wallet v3 - Per-Agent Escrow + Operator-Paid x402 Payments
;;
;; v3 upgrade: operator-paid model for autonomous agent payments on Stacks.
;;
;; Architecture:
...
;; Remainder from integer division goes to the service.
;;
